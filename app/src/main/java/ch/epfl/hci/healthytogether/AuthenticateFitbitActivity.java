...
public class AuthenticateFitbitActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// webView.loadUrl("http://grpupc1.epfl.ch/~yu/htexp/synch.php?uid="+uid);
	}
	...
	protected void onResume() {
		...
		@SuppressLint("StaticFieldLeak") CheckFitbitAuthenticationTask task = new CheckFitbitAuthenticationTask(
	...
	public void onOpenFitbiWebsiteButtonClicked(View v) {
		int uid = AppContext.getInstance().getUserId();
		// Open the authorization page in a browser. Yaliang, Dec.1, 2017. ******************************
		String fitbitUrl = "http://reach.bitnamiapp.com/php_HT/synch4.php?uid="
				+ uid;
