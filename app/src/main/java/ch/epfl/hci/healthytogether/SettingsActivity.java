...
public class SettingsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Utils.isConnectionPresent(SettingsActivity.this)) {
			...
			settingsScreenSetup();
			Log.i("SettingsActivity", "* isConnectionPresent");
		} else {
			displayConnectionErrorDialog();
			Log.i("SettingsActivity", "*Not isConnectionPresent");
		}
	...
	private void settingsScreenSetup() {
		...
		Log.i("SettingActivity", "settingsScreenSetup, step 0 ***");
	...
	public void onOpenFitbiWebsiteButtonClicked(View v) {
		Log.i("This", "onOpenFitbiWebsiteButtonClicked");
		int uid = AppContext.getInstance().getUserId();
		//Log.i("onOpenFitbiWebsiteButtonClicked", uid);
		//Open the Authorization page. Yaliang. Dec.1, 2017 ******************************************
		String fitbitUrl = "https://reach.bitnamiapp.com/php_HT/synch4.php?uid="
				+ uid;
	...
	public void countIncomingInvitations() {
		incomingInvitationsCount = 0;
		Log.i("This", "countIncomingInvitations");
		buddyEmails.clear();
	...
	public void displayConnectionErrorDialog(boolean show) {
		Log.i("SettingActivity", "displayConnectionErrorDialog");
		if (show) {
			displayConnectionErrorDialog();
	...
	private void showProgressDialog(final boolean show) {
		...
		if (!isDisplayingConnectionErrorDialog) {
			if (show) {
				...
				Log.i("SettingActivity", "showProgressDialog");
			}
		}
	}
	...
	private void hideInvitationUI(boolean hide)
	{
		...
		Log.i("SettingActivity", "hideInvitationUI");
	...
	{
		Log.i("SettingActivity", "hideAuthenticationUI");
